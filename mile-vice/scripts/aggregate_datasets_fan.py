...
dataset_folders = [
    '/hps/nobackup/research/gerstung/josegcpa/data/results/MLL_TIFF/_aggregates_wbc',
    '/hps/nobackup/research/gerstung/josegcpa/data/results/MLL_TIFF/_aggregates_rbc',
    '/hps/nobackup/research/gerstung/josegcpa/data/results/ADDEN_NDPI/_aggregates_wbc',
    '/hps/nobackup/research/gerstung/josegcpa/data/results/ADDEN_NDPI/_aggregates_rbc',
    '/hps/nobackup/research/gerstung/josegcpa/data/results/ADDEN_SVS_results/_aggregates_wbc',
    '/hps/nobackup/research/gerstung/josegcpa/data/results/ADDEN_SVS_results/_aggregates_rbc']
...
dataset_output = [x + '_fan.h5' for x in dataset_output_root]
...
dataset_output = [x + '_fan_subset.h5' for x in dataset_output_root]
...
dataset_output = [x + '_fan_subset_unbiased.h5' for x in dataset_output_root]

generate_dataset(dataset_folders[0],dataset_output[0],
                 m_wbc,M_wbc,
                 wbc_feature_subset_unbiased)
generate_dataset(dataset_folders[1],dataset_output[1],
                 m_rbc,M_rbc,
                 rbc_feature_subset_unbiased)
generate_dataset(dataset_folders[2],dataset_output[2],
                 m_wbc,M_wbc,
                 wbc_feature_subset_unbiased)
generate_dataset(dataset_folders[3],dataset_output[3],
