...
all_metrics <- rbind(
  read_csv(
    "../mile-vice/metrics/cv_subset_unbiased_metrics_df.csv",
...
probs_class <- rbind(
  read_csv(
    "../mile-vice/metrics/cv_subset_unbiased_probs.csv",
...
par(mfrow=c(2,2))
for (file_path in list.files("../mile-vice/ev-scores",pattern = "cv_subset_unbiased\\.",full.names = T)) {
