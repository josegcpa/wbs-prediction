...
Here I exclude features which have some predictive power (either AUC < 0.35 or AUC > 0.65) in terms of predicting the dataset from which the data originated. 
